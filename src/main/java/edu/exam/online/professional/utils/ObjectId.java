    ...
    static {
        ...
        try {
            ...
            int machinePiece;
            {
                ...
                log.info("machine piece post:{} " ,Integer.toHexString(machinePiece));
            }
            ...
            final int processPiece;
            {
                ...
                log.info("process piece: {}" , Integer.toHexString(processPiece));
            }

            _genmachine = machinePiece | processPiece;
            log.info("machine : {}", Integer.toHexString(_genmachine));
        } catch (Exception e) {
